...
const AICardShowcase = ({ simStep, simulationSteps, isCentered, isBankID }) => {
  ...
  return (
    <div className={`relative p-4 sm:p-6 md:p-12 ${isCentered ? 'max-w-md mx-auto' : ''}`}>
      <div className={`relative bg-white rounded-2xl sm:rounded-[2.5rem] shadow-2xl ${shadowColor} p-5 sm:p-8 md:p-10 space-y-4 sm:space-y-6 border border-gray-100`}>
        <div className="flex items-center space-x-3 sm:space-x-4">
          <div className={`w-12 h-12 sm:w-14 sm:h-14 ${progressColor} rounded-xl flex items-center justify-center shadow-lg`}>
            {isBankID ? <QrCode className="text-white" size={24} /> : <Brain className="text-white" size={24} />}
          </div>
          <div>
            <div className="text-base sm:text-lg font-bold text-gray-800">David AI</div>
            <div className="text-xs sm:text-sm text-gray-500">{isBankID ? 'BankID-verifiering' : 'Din personliga assistent'}</div>
          </div>
        </div>
        <div className={`${bgColor} rounded-xl p-4 sm:p-5 space-y-2 sm:space-y-3 border`}>
          <div className="text-xs sm:text-sm text-gray-700 font-medium">{isBankID ? 'BankID-flöde:' : 'David AI kör analys:'}</div>
        ...
        <div className="flex justify-between text-sm sm:text-base border-t pt-3 sm:pt-4">
...
const BankIDVerifyView = ({ personalNumber, setPersonalNumber, signing, handleBankIDSign, goToHome }) => {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen pt-20 sm:pt-24 pb-8 sm:pb-12 px-4 sm:px-6 bg-gradient-to-br from-emerald-50 via-green-50 to-lime-50">
      <div className="bg-white p-6 sm:p-8 md:p-10 rounded-2xl sm:rounded-3xl shadow-2xl max-w-md w-full my-4 sm:my-8">
        <div className="text-center mb-6 sm:mb-8">
          <div className="w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-r from-green-500 to-lime-600 rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4 shadow-lg">
            <Shield className="text-white" size={32} />
          </div>
          <h2 className="text-2xl sm:text-3xl font-extrabold text-gray-900 mb-2 sm:mb-3">Verifiera med BankID</h2>
          <p className="text-sm sm:text-base text-gray-600">För att slutföra din registrering behöver vi verifiera din identitet</p>
        </div>
...
export default function NiceslyWebsite() {
  ...
  const GenericSignInView = () => (
    <div className="flex flex-col items-center justify-center min-h-screen pt-20 sm:pt-24 pb-8 sm:pb-12 px-4 sm:px-6 bg-gradient-to-br from-gray-50 to-blue-50">
      <div className="bg-white p-6 sm:p-8 md:p-10 rounded-2xl sm:rounded-3xl shadow-2xl max-w-md w-full my-4 sm:my-8">
        <div className="text-center mb-6 sm:mb-8">
          <h2 className="text-3xl sm:text-4xl font-extrabold text-gray-900 mb-2 sm:mb-3">Skapa konto</h2>
          <p className="text-sm sm:text-base text-gray-600">Välj hur du vill registrera dig och komma igång</p>
        </div>
  ...
  const LoginView = () => (
    <div className="flex flex-col items-center justify-center min-h-screen pt-20 sm:pt-24 pb-8 sm:pb-12 px-4 sm:px-6 bg-gradient-to-br from-gray-50 to-blue-50">
      <div className="bg-white p-6 sm:p-8 md:p-10 rounded-2xl sm:rounded-3xl shadow-2xl max-w-md w-full my-4 sm:my-8">
        <div className="text-center mb-6 sm:mb-8">
          <h2 className="text-3xl sm:text-4xl font-extrabold text-gray-900 mb-2 sm:mb-3">Logga in</h2>
          <p className="text-sm sm:text-base text-gray-600">Välkommen tillbaka till Mitt Nicesly</p>
        </div>
  ...
  const HomeContent = ({ goToBankID }) => (
    <>
      {/* Hero Section */}
      <section className={`pt-24 sm:pt-32 md:pt-40 pb-16 sm:pb-20 md:pb-28 px-4 sm:px-6 ${heroBgClass}`}>
          ...
          <div className="grid md:grid-cols-2 gap-8 sm:gap-12 md:gap-16 items-center">
            <div className="space-y-6 sm:space-y-8">
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
                <button
                  onClick={goToGenericSignIn}
                  className="w-full sm:w-auto px-6 sm:px-8 py-3 sm:py-4 bg-gradient-to-r from-cyan-500 to-blue-600 text-white rounded-full text-base sm:text-lg font-semibold hover:shadow-cyan-400/70 shadow-xl transition transform hover:scale-[1.02] active:scale-[0.98] flex items-center justify-center touch-manipulation"
                >
                  Agera idag
                  <ArrowRight className="ml-2" size={20} />
                </button>
                <a href="#how" className="w-full sm:w-auto inline-block px-6 sm:px-8 py-3 sm:py-4 border-2 border-cyan-500 text-cyan-600 rounded-full text-base sm:text-lg font-semibold hover:bg-cyan-50 transition transform hover:shadow-md active:scale-[0.98] text-center touch-manipulation">
                  Se hur det fungerar
                </a>
              </div>
              <div className="flex flex-wrap gap-x-4 sm:gap-x-6 gap-y-2 sm:gap-y-3 items-center text-sm sm:text-base text-gray-600">
                <div className="flex items-center">
                  <CheckCircle className="text-green-500 mr-2 flex-shrink-0" size={18} />
                  <span>Svar på under 3 min</span>
                </div>
                <div className="flex items-center">
                  <CheckCircle className="text-green-500 mr-2 flex-shrink-0" size={18} />
      ...
      <section className="py-12 sm:py-16 md:py-24 bg-white px-4 sm:px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-10 sm:mb-12 md:mb-16">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-gray-900 mb-3 sm:mb-4">Därför är det svårt att agera</h2>
      ...
      <section className="py-10 sm:py-12 md:py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 sm:gap-6 text-center border-t border-b py-6 sm:py-6">
            <div className="pb-6 sm:pb-0 border-b sm:border-b-0">
              <div className="text-3xl sm:text-4xl md:text-5xl font-extrabold bg-gradient-to-r from-cyan-500 to-blue-600 bg-clip-text text-transparent">337,000+</div>
              <div className="text-gray-600 mt-2 text-base sm:text-lg font-medium">Svenskar med skulder hos KFM</div>
            </div>
            <div className="pb-6 sm:pb-0 border-b sm:border-b-0 sm:border-l sm:border-r border-gray-200">
              <div className="text-3xl sm:text-4xl md:text-5xl font-extrabold bg-gradient-to-r from-cyan-500 to-blue-600 bg-clip-text text-transparent">&lt;3 min</div>
              <div className="text-gray-600 mt-2 text-base sm:text-lg font-medium">Genomsnittlig svarstid (AI)</div>
            </div>
            <div>
              <div className="text-3xl sm:text-4xl md:text-5xl font-extrabold bg-gradient-to-r from-cyan-500 to-blue-600 bg-clip-text text-transparent">49 kr</div>
              <div className="text-gray-600 mt-2 text-base sm:text-lg font-medium">Pris från, ingen bindning</div>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* How It Works */}
      <section id="how" className="py-12 sm:py-16 md:py-24 bg-gradient-to-br from-gray-50 to-blue-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-10 sm:mb-12 md:mb-16">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-gray-900 mb-3 sm:mb-4">Hur Nicesly fungerar</h2>
            <p className="text-base sm:text-lg md:text-xl text-gray-600">Tre enkla steg till ekonomisk trygghet med David AI</p>
          </div>
      ...
      <section id="benefits" className="py-12 sm:py-16 md:py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-10 sm:mb-12 md:mb-16">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-gray-900 mb-3 sm:mb-4">Varför välja Nicesly?</h2>
            <p className="text-base sm:text-lg md:text-xl text-gray-600">Ingen gör det vi gör. Vi är den första digitala skuldskölden i Sverige.</p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 md:gap-x-12 md:gap-y-10">
            {[
              {
                icon: <Shield size={28} />,
      ...
      {/* Pricing */}
      <section id="pricing" className="py-12 sm:py-16 md:py-24 bg-gradient-to-br from-cyan-50 to-blue-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-10 sm:mb-12">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-gray-900 mb-3 sm:mb-4">Transparent Prissättning</h2>
            <p className="text-base sm:text-lg md:text-xl text-gray-600 px-4">Välj den skyddsnivå och kommunikationsform som passar din situation bäst</p>
          </div>

          {/* Pricing Cards Grid */}
          <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 items-stretch">
      ...
      {/* CTA Section */}
      <section className="py-12 sm:py-16 md:py-24 bg-gradient-to-r from-cyan-600 to-blue-700 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold mb-4 sm:mb-6">Redo att ta kontroll över din ekonomi?</h2>
          ...
          <button
            onClick={goToBankID}
            className="w-full sm:w-auto px-8 sm:px-12 py-3 sm:py-4 bg-white text-cyan-600 rounded-full text-lg sm:text-xl font-semibold hover:shadow-lg transition transform hover:scale-105 active:scale-[0.98] touch-manipulation"
          >
            Kom igång idag
          </button>
        </div>
